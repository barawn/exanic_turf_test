...
create_clock -period 100 -name clk_10mhz [get_ports clk_10mhz]

connect_debug_port dbg_hub/clk [get_pins u_init_clk/O]

# LEDs
set_property -dict {LOC J12 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports {sfp_2_led[0]}]
set_property -dict {LOC H12 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports {sfp_2_led[1]}]
set_property -dict {LOC J13 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports {sfp_1_led[0]}]
set_property -dict {LOC H13 IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports {sfp_1_led[1]}]
...
set_false_path -to [get_ports {sfp_2_led[*] sfp_1_led[*] sma_led[*]}]
set_output_delay 0 [get_ports {sfp_2_led[*] sfp_1_led[*] sma_led[*]}]
...
# Config
set_property -dict {LOC C14  IOSTANDARD LVCMOS33 PULLUP true} [get_ports ddr_npres]

# I literally swapped SFP2 and SFP1 here because of how I connected the damn
# thing.


# SFP28 Interfaces
set_property -dict {LOC D2  } [get_ports sfp_2_rx_p] ;# MGTYRXP0_227 GTYE4_CHANNEL_X0Y12 / GTYE4_COMMON_X0Y3
set_property -dict {LOC D1  } [get_ports sfp_2_rx_n] ;# MGTYRXN0_227 GTYE4_CHANNEL_X0Y12 / GTYE4_COMMON_X0Y3
set_property -dict {LOC A4  } [get_ports sfp_1_rx_p] ;# MGTYRXP3_227 GTYE4_CHANNEL_X0Y15 / GTYE4_COMMON_X0Y3
set_property -dict {LOC A3  } [get_ports sfp_1_rx_n] ;# MGTYRXN3_227 GTYE4_CHANNEL_X0Y15 / GTYE4_COMMON_X0Y3
set_property -dict {LOC F7  } [get_ports sfp_2_tx_p] ;# MGTYTXP0_227 GTYE4_CHANNEL_X0Y12 / GTYE4_COMMON_X0Y3
set_property -dict {LOC F6  } [get_ports sfp_2_tx_n] ;# MGTYTXN0_227 GTYE4_CHANNEL_X0Y12 / GTYE4_COMMON_X0Y3
set_property -dict {LOC B7  } [get_ports sfp_1_tx_p] ;# MGTYTXP3_227 GTYE4_CHANNEL_X0Y15 / GTYE4_COMMON_X0Y3
set_property -dict {LOC B6  } [get_ports sfp_1_tx_n] ;# MGTYTXN3_227 GTYE4_CHANNEL_X0Y15 / GTYE4_COMMON_X0Y3
...
set_property -dict {LOC AC17 IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 12} [get_ports sfp_2_tx_disable]
set_property -dict {LOC AA17 IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 12} [get_ports sfp_1_tx_disable]
set_property -dict {LOC F12  IOSTANDARD LVCMOS33 PULLUP true} [get_ports sfp_2_npres]
set_property -dict {LOC F14  IOSTANDARD LVCMOS33 PULLUP true} [get_ports sfp_1_npres]
set_property -dict {LOC AC16 IOSTANDARD LVCMOS18 PULLUP true} [get_ports sfp_2_los]
set_property -dict {LOC Y17  IOSTANDARD LVCMOS18 PULLUP true} [get_ports sfp_1_los]
set_property -dict {LOC G14  IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports sfp_2_rs]
set_property -dict {LOC H14  IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12} [get_ports sfp_1_rs]
#set_property -dict {LOC A10  IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12 PULLUP true} [get_ports sfp_i2c_scl]
#set_property -dict {LOC C11  IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12 PULLUP true} [get_ports sfp_2_i2c_sda]
#set_property -dict {LOC B11  IOSTANDARD LVCMOS33 SLEW SLOW DRIVE 12 PULLUP true} [get_ports sfp_1_i2c_sda]

# 161.1328125 MHz MGT reference clock
create_clock -period 6.206 -name sfp_mgt_refclk [get_ports sfp_mgt_refclk_p]

set_false_path -to [get_ports {sfp_2_tx_disable sfp_1_tx_disable sfp_2_rs sfp_1_rs}]
set_output_delay 0 [get_ports {sfp_2_tx_disable sfp_1_tx_disable sfp_2_rs sfp_1_rs}]
set_false_path -from [get_ports {sfp_2_npres sfp_1_npres sfp_2_los sfp_1_los}]
set_input_delay 0 [get_ports {sfp_2_npres sfp_1_npres sfp_2_los sfp_1_los}]

#set_false_path -to [get_ports {sfp_2_i2c_sda sfp_1_i2c_sda sfp_i2c_scl}]
#set_output_delay 0 [get_ports {sfp_2_i2c_sda sfp_1_i2c_sda sfp_i2c_scl}]
#set_false_path -from [get_ports {sfp_2_i2c_sda sfp_1_i2c_sda sfp_i2c_scl}]
#set_input_delay 0 [get_ports {sfp_2_i2c_sda sfp_1_i2c_sda sfp_i2c_scl}]
...
# false paths
set_clock_groups -name async1 -asynchronous -group [get_clocks {pcie_mgt_refclk}] \
